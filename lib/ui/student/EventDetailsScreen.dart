...
class _EventDetailsScreenState extends State<EventDetailsScreen> {
  ...
  void initState() {
    ...
    Timer(Duration(milliseconds: 100), () {
      String tempDate =
          DateFormat("yyyy-MM-dd'T'hh:mm:ss").format(widget.event.date);
              ...
              body: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      height: MediaQuery.of(context).size.height * 0.88,
                      child: sameDayEventList.length > 0
                          ? ListView.builder(
  ...
  _listRowItems(BuildContext context, int index) {
    ...
    return Container(
      decoration: BoxDecoration(
          ...
          color: Colors.white,
          border: Border.all(color: HexColor("#6462AA"), width: 0.5)),
      ...
      child: Column(
        ...
        children: [
          Text(sameDayEventList[index].eventName,
              style: AppTheme.customTextStyle(
          ...
          Text(
              'total_day'.tr() + ': ' + getDayCount(localFromDate, localToDate),
              style: AppTheme.regularTextStyle()
                  .copyWith(fontSize: 16, color: Colors.black54)),
          SizedBox(height: 10),
          Text('event_details'.tr() + ':',
              style: AppTheme.regularTextStyle()
                  .copyWith(fontSize: 16, color: Colors.black54)),
          Html(
