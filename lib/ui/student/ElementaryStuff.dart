...
class ElementaryStuff extends StatefulWidget {
  ElementaryStuff(this.sortLanguageCode);
...
class _ElementaryStuffState extends State<ElementaryStuff> {
  List<GridListItems> menuItems = [
    ...
    GridListItems(name: 'articles'.tr(), svgPicture: MyImage.calenderIcon),
    GridListItems(name: 'stories'.tr(), svgPicture: MyImage.universityIcon),
  ];
                      ...
                      onTap: () {
                        if (index == 0) {
                          ...
                          Utils.navigateToScreen(context,
                              VideoListScreen('videos'.tr(), "Student"));
                        } else if (index == 1) {
                          Utils.navigateToScreen(
                              context, BlogScreen('articles'.tr(), "Student"));
                        } else {
                          Utils.navigateToScreen(
                              context, BlogScreen('stories'.tr(), "Student"));
                        }
                      },
                      child: Card(
